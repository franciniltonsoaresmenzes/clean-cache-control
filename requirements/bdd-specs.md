...
```
Dado um cliente tem conexão com a internnet 
Quando o cliente solicitar para caregar suas compras
Então o sistema deve exibir suar compras vindo de uma API
...
Para eu poder ver minhas mesmo sem ter internet.
```
...
Dado que o cliente não tem conexão com a internet
  E exita algum dado gravado no cache
